    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.CharField(blank=True, choices=[('USD', 'US Dollar'), ('EUR', 'Euro'), ('GBP', 'British Pound'), ('CAD', 'Canadian Dollar'), ('AUD', 'Australian Dollar'), ('NZD', 'New Zealand Dollar'), ('CHF', 'Swiss Franc'), ('JPY', 'Japanese Yen'), ('CNY', 'Chinese Yuan')], default='USD', max_length=3, null=True)),
                ...
                ('applicants', models.ManyToManyField(blank=True, null=True, related_name='job_applicants', to=settings.AUTH_USER_MODEL)),
